...
{
    #[Route('/', name: 'admin_app_setting_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'admin_app_setting_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_app_setting_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'admin_app_setting_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'admin_app_setting_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'admin_app_setting_delete', methods: ['POST'])]
